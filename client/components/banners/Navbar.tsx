    ...
    <header className="bg-white w-screen text-gray-700 body-font">
      <div className="container mx-auto flex flex-wrap p-4 flex-col md:flex-row items-center">
        ...
        <button
          type="button"
          // onClick={() => {}}
          className="inline-flex items-center bg-primary shadow-outline-blue text-white border-0 py-2 px-20 md:px-4 transition ease-in-out duration-500 hover:shadow-md focus:outline-none rounded text-base mt-4 md:mt-0"
        >
          Get Started
        </button>
      </div>
